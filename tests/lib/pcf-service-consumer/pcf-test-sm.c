...
static void pcf_test_state_operational(ogs_fsm_t *s, pcf_test_event_t *e);
...
void pcf_test_state_initial(ogs_fsm_t *s, pcf_test_event_t *e)
{
    ...
    OGS_FSM_TRAN(s, &pcf_test_state_operational);
}
...
static void pcf_test_state_operational(ogs_fsm_t *s, pcf_test_event_t *e)
{
    ...
    ogs_debug("pcf_test_state_operational");
    if (pcf_session_process_event(e))
        return;
    ...
    case OGS_EVENT_SBI_SERVER:
        ...
        CASE(OGS_SBI_SERVICE_NAME_NPCF_POLICYAUTHORIZATION)
            ...
            CASE(OGS_SBI_RESOURCE_NAME_APP_SESSIONS)
                //pcf_test_sess_t *app_session = NULL;
    ...
    case OGS_EVENT_SBI_CLIENT:
        ...
        CASE(OGS_SBI_SERVICE_NAME_NBSF_MANAGEMENT)
	    	...
	    	/*
                sbi_xact = e->h.sbi.data;
		ogs_error("Got OGS_SBI_RESOURCE_NAME_PCF_BINDINGS method: %s %d", message.h.method, message.res_status);
                ogs_assert(sbi_xact);
		...
		*/
	  	 ...
	  	 /*   ogs_error("SBI transaction has already been removed");
                ...
                sess = (bsf_test_sess_t *)sbi_xact->sbi_object;
                ogs_assert(sess);
    ...
    default:
        ogs_error("No handler for event %s", pcf_test_event_get_name(e));
        break;
    }
}
